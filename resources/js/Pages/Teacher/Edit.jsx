...
export default function Edit({user, teacher, classes, section, subject}){

    console.log(teacher.id)
    const {data, progress, setData, put:update } = useForm({
        fullname: user.name,
        email: user.email,
        password: "",
            ...
            <form onSubmit={handleSubmit}>
                <div className={classNames("grid grid-cols-3 gap-4 my-2")}>
                    ...
                    <div className={classNames("photo")}>
                        ...
                        <img src={`/storage/uploads/teachers/${teacher.photo}`} className={classNames('w-20 h-20 mt-2')} />
                    </div>
